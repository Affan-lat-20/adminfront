        ...
        <Row>
          <Col lg={12}>
            ...
            >
              ...
              <Col lg={4}>
                {props.message === "Successfully Deleted." ?<FontAwesomeIcon icon={faCheckCircle} size="3x" color="green" className="margin-top-40 margin-left-30 modal-mobile-size"/>:null}
